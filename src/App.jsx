    ...
    <div className="about-page">
          ...
          <div className="contact-luxury-grid">
            ...
            >
              ...
              >
                ...
                >
                  JOIN OVER 10,000+ HAPPY HAIR GROWTH LOVERS
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="section-padding container">
        ...
        >
          ...
          >
            Experience Healthy Hair Today.
          </h2>
          <p
            style={{ fontSize: "1.2rem", color: "#666", marginBottom: "3rem" }}
          >
            Join the thousands of individuals who have transformed their hair
            through our organic products.
          </p>
          <Link to="/shop" className="cta-button-premium">
            Explore All Products
          </Link>
    ...
    <div className="shop-page-wrapper">
      ...
      <section className="shop-hero">
        <div className="center-text reveal">
          <span className="shop-hero-brand">Lina Hair Care Products</span>
          <h1 className="serif shop-hero-title">Pure Hair Beauty</h1>
        </div>
      </section>
              ...
              <div className="mobile-shop-header mobile-only">
                <div className="mobile-page-title-area">
                  ...
                  <p className="mobile-shop-subtitle">
                    Lina Hair Care — Natural beauty online
                  </p>
                </div>
                      ...
                      >
                        {activeCategory === cat.id && (
                          <div className="cat-icon-circle">
                            <ShoppingBag size={12} color="#013220" />
                          </div>
                        )}
                        <span>{cat.label}</span>
                      </button>
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#013220] text-white py-3 rounded-md font-bold mt-4 hover:bg-[#002010] transition-colors"
          >
...
const AuthPage = ({ onLogin }) => {
  ...
  const handleLogin = async (e) => {
    ...
    if (res.success) {
      Swal.fire({
        title: `Welcome Back, ${res.name && res.name !== "Lina Admin" && res.name !== "Admin"
          ? res.name.split(" ")[0]
          : "Florence"
          }!`,
      ...
      <div className="auth-container">
        <div className={`auth-card glass reveal ${isLoaded ? "active" : ""}`}>
          <div className="auth-card-header">
            ...
            <h2 className="serif">Lina Product Portal</h2>
            ...
            <div className="auth-input-wrapper">
              ...
              <div className="auth-input-group">
                ...
                <input
                  type="text"
                  required
                  placeholder="admin@linahaircare.com or +233..."
                  value={identifier}
          ...
          <footer className="auth-card-footer">
            <p className="auth-footer-text">
              ...
              Authorized Lina Hair Care Personnel Only.
            </p>
          </footer>
        </div>
      </div>
    ...
    <div className={`dashboard-layout ${isMinimized ? "minimized" : ""}`}>
      ...
      >
        ...
        <nav className="sidebar-nav">
          ...
          <Link
            to="/admin/inventory"
            className={`sidebar-link ${location.pathname.startsWith("/admin/inventory") ? "active" : ""}`}
          >
            <BarChart3 size={18} />
      ...
      <main className="admin-main">
        ...
        <Routes>
          ...
          <Route
            path="/inventory"
            element={<AdminInventory products={products} />}
          />
          {/* Default to Overview */}
          <Route
            path="*"
      ...
      <nav className="admin-bottom-nav">
        ...
        <Link
          to="/admin/inventory"
          className={`bottom-nav-link ${location.pathname.startsWith("/admin/inventory") ? "active" : ""}`}
        >
          <BarChart3 size={22} />
          <span>Health</span>
        </Link>
    ...
    <div className="dashboard-view fade-in">
      ...
      <div className="dashboard-grid">
        ...
        <div className="admin-card">
          ...
          <div
            className="inventory-alerts-list"
              ...
              .map((prod, i) => (
                <div
                  ...
                  style={{
                    ...
                    alignItems: "center",
                    padding: "1.25rem",
                    background: prod.stock <= 2 ? "#fff5f5" : "#fffbeb",
                    borderRadius: "16px",
                    border: `1px solid ${prod.stock <= 2 ? "#fee2e2" : "#fef3c7"}`,
                  }}
                >
                  <div>
                    ...
                    <span
                      style={{
                        fontSize: "0.75rem",
                        color: prod.stock <= 2 ? "#991b1b" : "#92400e",
                        fontWeight: 800,
                      }}
                    >
                  ...
                  <button
                    style={{ color: prod.stock <= 2 ? "#991b1b" : "#92400e" }}
                  >
                    <Package size={18} />
                  </button>
                </div>
...
const ReceiptModal = ({ order, onClose }) => {
  ...
  const handleDownloadAndShare = async () => {
    ...
    try {
      ...
      const waText = `Hello ${order.customer}, thank you for your purchase from Lina Hair Care Products! We've attached your digital receipt RC-${order.orderId?.split("-")[1]?.toUpperCase() || order._id} for your records. Let us know if you need anything else!`;
        ...
        >
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            >
              <h2
                className="serif"
                style={{ color: "#013220", fontSize: "1.8rem", margin: "0" }}
              >
                Lina Hair Care Products
              </h2>
              <p
  ...
  return (
    <div className="checkout-page section-padding container">
      <div className="reveal checkout-header">
        ...
        <p className="text-teal">Lina Hair Care Fast Delivery</p>
      </div>
          ...
          <div className="glass shadowed order-summary-card">
            ...
            <div className="guarantee-box">
              ...
              <div className="guarantee-text">
                <p className="guarantee-title">Authentic Products Guaranteed</p>
                <p className="guarantee-desc">
                  Secure payment direct to Lina Hair Care.
                </p>
              </div>
            </div>
          </div>
